...
// Array of color scheme objects
const colorSchemes = [
    {
        name: 'Default', // Name of the color scheme
        body: '#f0f2f5', // Background color of the body
        container: 'white', // Background color of the container
        header: '#4a4a4a', // Background color of the header
        headerText: 'white', // Text color of the header
        inputBg: '#f0f2f5', // Background color of the input field
        inputText: 'black', // Text color of the input field
        sendButton: '#0084ff', // Background color of the send button
        sendButtonText: 'white', // Text color of the send button
        userMessage: '#0084ff', // Background color of user messages
        userMessageText: 'white', // Text color of user messages
        botMessage: '#e4e6eb', // Background color of bot messages
        botMessageText: 'black' // Text color of bot messages
    },
    {
        name: 'Dark Mode',
        body: '#1a1a1a',
